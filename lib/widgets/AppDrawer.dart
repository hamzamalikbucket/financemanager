      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _createDrawerItem(
              icon: Image.asset("assets/images/upload.png",color: MyColors.whiteColor),
              text: 'Upload Data',
              onTap: () =>
                  Navigator.pushNamed(context, Constants.homeScreen),
            ),
            ...
            _createDrawerItem(
              icon: Image.asset("assets/images/download.png",color: MyColors.whiteColor),
              text: 'Download Data',
              onTap: () => Navigator.pushNamed(context, Constants.homeScreen),
            ),
