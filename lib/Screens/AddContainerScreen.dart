...
class AddAState extends State<AddContainerScreen>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ToolbarBack(appBar: AppBar(), title: 'New Container',),
      body: SafeArea(
  ...
  Future<dynamic> addItem() async {
    var url = Uri.parse('${Utils.baseUrl}addContainer');
    var response = await http
        .post(
      url,
      body: {"name": Title,"user_id":Utils.USER_ID.toString()},
