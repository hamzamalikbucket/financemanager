...
class AddExpensesState extends State<AddExpensesScreen>{
  ...
  Widget build(BuildContext context) {
    cmd= ModalRoute.of(context)!.settings.arguments as ContainerModel;
    return Scaffold(

      appBar: ToolbarBack(appBar: AppBar(), title: cmd.ContainerName!,),
      body: SafeArea(
  ...
  Future<dynamic> addItem() async {
    var url = Uri.parse('${Utils.baseUrl}addExpense');
    var response = await http
        .post(
      url,
      body: {"user_id":Utils.USER_ID.toString(),"description":Title.toString(),"amount":amount,"container_id":cmd.conatinerId},
