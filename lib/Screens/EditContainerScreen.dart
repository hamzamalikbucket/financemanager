...
class AddAState extends State<EditContainerScreen>{
  ...
  Widget build(BuildContext context) {
    containerModel= ModalRoute.of(context)!.settings.arguments as ContainerModel;
    return Scaffold(

      appBar: ToolbarBack(appBar: AppBar(), title: 'Edit Container',),
      body: SafeArea(
        ...
        child: Column(
          ...
          children: <Widget>[
            NameInputWidget(
                ...
                error: "Enter Name",
                initialval: containerModel.ContainerName,
                isRequired: true,
                icon: Icons.title,
  ...
  Future<dynamic> addItem() async {
    var url = Uri.parse('${Utils.baseUrl}editContainer');
    var response = await http
        .post(
      url,
      body: {"name": Title,"user_id":Utils.USER_ID.toString(),"id":containerModel.conatinerId},
